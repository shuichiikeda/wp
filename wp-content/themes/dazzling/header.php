...
<div id="page" class="hfeed site">
	...
	<nav class="navbar navbar-default" role="navigation">
        ...
        <nav class="original-nav">
          <ul class="main-category-list" style="margin-top: 94px;">
              <li style="list-style-type: none;">カテゴリー</li>
              <?php wp_list_categories('title_li=&show_count=1&use_desc_for_title=1&depth=0&orderby=count&&order=DESC'); //カテゴリの呼び出し?>
          </ul>
        </nav>
